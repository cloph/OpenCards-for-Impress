...
public class LTMProcessManager extends LearnProcessManager {
    ...
    protected int numScheduled;
    protected int numNewScheduled;

    protected int numProcessed;
    protected int numNewProcessed;
    ...
    private Map<CardFile, List<Item>> skippedItems = new HashMap<CardFile, List<Item>>();
    private Map<CardFile, List<Item>> newButNotSchedItems = new HashMap<CardFile, List<Item>>();
...
//            ((AbstractLearnDialog) itemValuater).updateStatus(completeness, (numScheduled - numProcessed) + " " + Utils.getRB().getString("AbstractLearnDialog.statusbar.text"));
            ...
            String msg = (numScheduled - numProcessed) + "";
            if (((SMLearnDialog) itemValuater).getSizeRatio() > 1)
                msg += " " + Utils.getRB().getString("AbstractLearnDialog.statusbar.text");
