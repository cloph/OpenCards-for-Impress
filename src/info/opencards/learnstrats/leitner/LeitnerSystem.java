...
public class LeitnerSystem extends ItemCollection {
    ...
    private List<List<LeitnerItem>> boxes;
    ...
    public void createItem(FlashCard flashCard) {
    ...
    public List<LeitnerItem> getBoxOf(LeitnerItem item) {
    ...
    public synchronized List<LeitnerListener> getLeitnerListeners() {
