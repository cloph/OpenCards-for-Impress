...
public abstract class LeitnerLearning extends LearnMethod {
    ...
    protected LeitnerSystem leitnerSystem;

    protected List<Item> skipList = new ArrayList<Item>();

    private Item lastItem;


    public LeitnerLearning(ItemValuater itemValuater) {
        super(itemValuater);
    }
     ...
     */
    protected boolean updateLeitnerSystem(LeitnerItem item, Integer feedback) {
        lastItem = null;
    ...
    protected boolean didKnew(Integer feedback) {
