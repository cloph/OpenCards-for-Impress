...
public class ScaleableIcon implements Icon {
    ...
    public ScaleableIcon(String iconResourcePath, int width, int height) {
        this(new ImageIcon(Utils.getOCClass().getResource(iconResourcePath)), width, height);
    }


    public ScaleableIcon(String iconResourcePath) {
        this(new ImageIcon(Utils.getOCClass().getResource(iconResourcePath)), DEF_ICON_WIDTH, DEF_ICON_HEIGHT);
    }
