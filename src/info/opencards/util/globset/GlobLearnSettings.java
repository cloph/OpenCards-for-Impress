...
public class GlobLearnSettings extends AbstractSettingsPanel {
    ...
    public static final boolean USE_SIMPLIFIED_INTERFACE_DEFAULT = false;
    ...
    private void initComponents() {
        ...
        //======== panel2 ========
        {
            panel2.setBorder(new CompoundBorder(
                    new TitledBorder(bundle.getString("GlobLearnSettings.panel2.border")),
        ...
        //======== schedulePanel ========
        {
            schedulePanel.setBorder(new CompoundBorder(
                    new TitledBorder(bundle.getString("GlobLearnSettings.schedulePanel.border")),
                    new EmptyBorder(5, 5, 5, 5)));
        ...
        //======== ustmPanel ========
        {
            ustmPanel.setBorder(new CompoundBorder(
                    new TitledBorder(bundle.getString("GlobLearnSettings.ustmPanel.border")),
                    new EmptyBorder(5, 5, 5, 5)));
