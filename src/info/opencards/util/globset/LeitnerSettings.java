...
public class LeitnerSettings extends AbstractSettingsPanel {
    ...
    public static final String USE_PERSISTENT_LEARN_SETTINGS = "advncd.persistence.learnsets";
    public static final Boolean USE_PERSISTENT_LEARN_SETTINGS_DEFAULT = true;
    ...
    void resetPanelSettings() {
        ...
        Utils.getPrefs().remove(USE_PERSISTENT_LEARN_SETTINGS);
...
//        Utils.getPrefs().putInt(PREFER_UNLEARNT_AMOUNT, incProbAmountCombo.getSelectedIndex());
        ...
        Utils.getPrefs().putBoolean(USE_PERSISTENT_LEARN_SETTINGS, usePerSetsBox.isSelected());
    }
    ...
    protected void loadDefaults() {
        ...
        usePerSetsBox.setSelected(Utils.getPrefs().getBoolean(USE_PERSISTENT_LEARN_SETTINGS, USE_PERSISTENT_LEARN_SETTINGS_DEFAULT));
    }
    ...
    private void initComponents() {
        ...
        //======== boxPanel ========
        {
            boxPanel.setBorder(new CompoundBorder(
                    new TitledBorder(bundle.getString("LeitnerSettings.boxPanel.border")),
        ...
        //======== learnPanel ========
        {
            learnPanel.setBorder(new CompoundBorder(
                    new TitledBorder(bundle.getString("LeitnerSettings.learnPanel.border")),
                    new EmptyBorder(5, 5, 5, 5)));
        ...
        //======== panel4 ========
        {
            panel4.setBorder(new CompoundBorder(
                    new TitledBorder(bundle.getString("LeitnerSettings.panel4.border")),
                    new EmptyBorder(5, 5, 5, 5)));
            panel4.setMinimumSize(null);
            panel4.setPreferredSize(null);
            panel4.setLayout(new GridBagLayout());
            ((GridBagLayout) panel4.getLayout()).columnWidths = new int[]{0, 43, 0};
            ((GridBagLayout) panel4.getLayout()).rowHeights = new int[]{0, 0};
            ((GridBagLayout) panel4.getLayout()).columnWeights = new double[]{0.0, 0.0, 1.0E-4};
            ((GridBagLayout) panel4.getLayout()).rowWeights = new double[]{0.0, 1.0E-4};

            //---- usePerSetsBox ----
            usePerSetsBox.setText(bundle.getString("LeitnerSettings.usePerSetsBox.text"));
            panel4.add(usePerSetsBox, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(0, 0, 0, 5), 0, 0));
        }
    ...
    private JCheckBox usePerSetsBox;
