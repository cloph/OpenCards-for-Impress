...
public class FlashCard implements Cloneable {
    ...
    // this field is not used any longer and will be removed soon
    transient private Map<Class<? extends Item>, Item> myItems;
    ...
    /**
     * Tests wether two falhcards (else if obj not instance of <code>FlashCards</code>) are equals based on the cardID.
     */
