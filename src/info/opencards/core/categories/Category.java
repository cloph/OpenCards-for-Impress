...
public class Category implements Cloneable {
    ...
    public Category getRootCategory() {
        Category retCat = getParent() != null ? getParent().getRootCategory() : this;
        return retCat;
    }
...
//        category.setParent(this);
    ...
    public Category cutChildren(Category child) {
        assert childCategories.contains(child);
        childCategories.remove(child);
    ...
    public Set<CardFile> getRecurseCardSets() {
    ...
    public boolean equals(Object o) {
        ...
        if (getParent() == null && cat.getParent() == null) //both might be the root category
            return cat.getName().equals(getName());

        if ((getParent() != null && cat.getParent() == null) || (getParent() == null && cat.getParent() != null))
            return false;
     ...
     */
    public Category getChildCategoryByName(String name) {
        for (Category category : getChildCategories()) {
