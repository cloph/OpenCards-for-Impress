...
public class CardFileSyncAction extends AbstractAction {
    ...
    public JDialog syncDialog;


    public CardFileSyncAction(JDialog awtOwner, String actionName) {
        this.awtOwner = awtOwner;

        putValue(NAME, actionName);
        putValue(SMALL_ICON, new ScaleableIcon("/resources/icons/synchronize.png"));
...
//        final JButton cancelLoading = new JButton();
        syncDialog = new JDialog(Utils.getOwnerDialog(awtOwner));
...
//        dialog.getContentPane().add(cancelLoading, BorderLayout.SOUTH);
        ...
        ((LearnManagerUI) Utils.getOwnerDialog(awtOwner)).refreshFileViews();
    }
