...
public class CategoryTree extends JTree {
    ...
    private List<CategoryTreeSelectionListener> cardSelectionListeners = new ArrayList<CategoryTreeSelectionListener>();
    ...
    public void setRootCategory(Category rootCat) {
        ...
        rootCat.addCategoryChangeListener(new CategoryChangeAdapter() {
            ...
            public void categoryChanged(Category category) {
                super.categoryChanged(category);
            }
        });
...
//        catTreeModel.getRootCategory().addCategoryChangeListener(new TreeModifier());
        ...
        setTransferHandler(new CardCategoryTransferHandler(catTreeModel));
        setSelectionRow(0);
