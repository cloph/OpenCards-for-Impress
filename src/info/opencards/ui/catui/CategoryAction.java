...
public abstract class CategoryAction extends AbstractAction {
    ...
    protected CategoryAction(CategoryTree categoryTree) {
...
class CreateCategoryAction extends CategoryAction {
    ...
    protected CreateCategoryAction(CategoryTree categoryTree) {
        super(categoryTree);
...
//        putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_N, KeyEvent.CTRL_DOWN_MASK));
    ...
    public void actionPerformed(ActionEvent e) {
        String newCatname = JOptionPane.showInputDialog(Utils.getOwnerDialog(categoryTree), Utils.getRB().getString("CategoryTree.addNewCategory.text"), Utils.getRB().getString("CategoryTree.addNewCategory.default"));
...
class DeleteCategoryAction extends CategoryAction {
    ...
    public DeleteCategoryAction(CategoryTree categoryTree) {
        ...
        putValue(SMALL_ICON, new ScaleableIcon("/resources/icons/category_remove.png"));
//        putValue(SHORT_DESCRIPTION, "cuts the selected category");
//        putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_D, KeyEvent.CTRL_DOWN_MASK));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        int status = JOptionPane.showConfirmDialog(Utils.getOwnerDialog(categoryTree),
...
class AddCardSetAction extends CategoryAction {
    ...
    private PasteCategoryAction pasteAction;
    ...
    public AddCardSetAction(CategoryTree categoryTree, PasteCategoryAction pasteAction) {
        ...
        putValue(SMALL_ICON, new ScaleableIcon("/resources/icons/category_addcardset.png"));
//        putValue(SHORT_DESCRIPTION, "cuts the selected category");
...
//                return (fileName.endsWith(".odp") || fileName.endsWith(".ppt")) || f.isDirectory();
                return (fileName.endsWith(".odp")) || f.isDirectory();
            }


            public String getDescription() {
//                return "Flashcard presentations (*.odp,  *.ppt)";
                return "Impress presentations (*.odp)";
            }
        });

        int status = jfc.showOpenDialog(Utils.getOwnerDialog(categoryTree));
        if (status == JFileChooser.APPROVE_OPTION) {
            ...
            Dialog owner = Utils.getOwnerDialog(categoryTree);
            ...
            new CardFilesPreloader(owner, ((LearnManagerUI) owner).getBackend().getSerializer()).categorySelectionChanged(cardFilesBuffer, null);
...
class PopulateSubCatTreeFromDirectoryAction extends CategoryAction {
    ...
    public PopulateSubCatTreeFromDirectoryAction(CategoryTree categoryTree) {
        ...
        putValue(SMALL_ICON, new ScaleableIcon("/resources/icons/category_add_dirtree.png"));
...
//        });
        ...
        if (jfc.showOpenDialog(Utils.getOwnerDialog(categoryTree)) != JFileChooser.APPROVE_OPTION) {
            return;
        }
...
//        Category rootCategory = baseCategory.getOrCreateChildCategoryByName(rootDirectory.getName());
        ...
        List<File> allFilesInSubDirectory = Utils.findOdpFiles(rootDirectory);
        ...
        // we cannot remove this one, because the preloader of the tree would process each file in a single run,
        // which wouldn't look nice because the the progress-bar would flicker for each file
        new CardFilesPreloader(owner, ((LearnManagerUI) owner).getBackend().getSerializer()).categorySelectionChanged(newCardFiles, null);
...
class CutCategoryAction extends CategoryAction {
    ...
    public CutCategoryAction(CategoryTree categoryTree, PasteCategoryAction pasteAction) {
        ...
        putValue(SMALL_ICON, new ScaleableIcon("/resources/icons/category_cut.png"));
//        putValue(SHORT_DESCRIPTION, "cuts the selected category");
...
class CopyCategoryAction extends CategoryAction {
    ...
    public CopyCategoryAction(CategoryTree categoryTree, PasteCategoryAction pasteAction) {
        ...
        putValue(SMALL_ICON, new ScaleableIcon("/resources/icons/category_copy.png"));
//        putValue(SHORT_DESCRIPTION, "cuts the selected category");
//        putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_X, KeyEvent.CTRL_DOWN_MASK));
        putValue(MNEMONIC_KEY, 2);
    }
...
class PasteCategoryAction extends CategoryAction {
    ...
    public PasteCategoryAction(CategoryTree categoryTree) {
        ...
        putValue(SMALL_ICON, new ScaleableIcon("/resources/icons/category_paste.png"));
//        putValue(SHORT_DESCRIPTION, "cuts the selected category");
...
class RenameCategoryAction extends CategoryAction {
    ...
    public RenameCategoryAction(CategoryTree categoryTree) {
        ...
        putValue(SMALL_ICON, new ScaleableIcon("/resources/icons/category_rename.png"));
//        putValue(SHORT_DESCRIPTION, "cuts the selected category");
//        putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_R, KeyEvent.CTRL_DOWN_MASK));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String newName = JOptionPane.showInputDialog(Utils.getOwnerDialog(categoryTree), "New category name", catName);
...
//        putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_R, KeyEvent.CTRL_DOWN_MASK));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        ((LearnManagerUI) Utils.getOwnerDialog(categoryTree)).refreshFileViews();
    }
}
