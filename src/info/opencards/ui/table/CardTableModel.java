...
public class CardTableModel extends DefaultTableModel implements CategoryTreeSelectionListener {
    ...
    private static boolean[] columnEditable = new boolean[]{false, false, false, false};
    private static String[] columnNames = new String[]{Utils.getRB().getString("CardTableModel.fileName"), Utils.getRB().getString("CardTableModel.nextScheduled"), Utils.getRB().getString("CardTableModel.numNewCards"), Utils.getRB().getString("CardTableModel.numCards")};

    private List<CardFile> curFiles = new ArrayList<CardFile>();
    private List<Category> curCategories = new ArrayList<Category>();
    public LTMProcessManager dummyLtmManager;
