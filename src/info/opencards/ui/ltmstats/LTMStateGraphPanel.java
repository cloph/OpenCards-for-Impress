 ...
 */
public class LTMStateGraphPanel extends JPanel {

    private DefaultCategoryDataset dataset;
    public ValueAxis valueAxis;

    public static final int NUM_HIST_BINS = 9;
    private Collection<CardFile> currentFiles;
    public String learnedPerfectly;
    public String learnedNotYet;
    private String learnedNaJa;
...
//        set2EDistribution(currentFiles);
    ...
    private boolean set2NumRepHist(Collection<CardFile> currentFiles) {
        ...
        for (int i = 0; i < numReps.size(); i++) {
            eHist[numReps.get(i) >= NUM_HIST_BINS - 1 ? NUM_HIST_BINS - 1 : numReps.get(i)]++;
        }
